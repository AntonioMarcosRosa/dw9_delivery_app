          ...
          actions: [
            TextButton(
              onPressed: () {
                ...
                controller.cancelDeleteProductProcess();
              },
              child: Text(
                'Cancelar',
    ...
    return BlocListener<OrderController, OrderState>(
      listener: (context, state) {
        state.status.matchAny(
            ...
            emptyBag: () {
              showInfo(
                  'Sua sacola está vazia, por favor selecione ao menos um produto para finalizar seu pedido.');
                    ...
                    child: Row(
                      children: [
                        ...
                        IconButton(
                          ...
                          icon:
                              Image.asset('lib/assets/images/trashRegular.png'),
                        ),
                      ],
                    ),
                  ),
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          BlocSelector<OrderController, OrderState, double>(
                            ...
                            builder: (context, totalOrder) => Text(
